...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddChat = __webpack_require__(148);
	var ChatList = __webpack_require__(150);
	      ...
	      React.createElement("div", {className: "container"}, 
	        React.createElement("div", {className: "row"}, 
	          React.createElement("div", {className: "col-sm-12"}, 
	            React.createElement("h1", {className: "text-center"}, " React Chatroom "), 
	            React.createElement("div", {className: "col-sm-8 col-sm-offset-2"}, 
	              React.createElement(AddChat, {url: "https://api.parse.com/1/classes/chat"})
	            ), 
	            React.createElement("div", {className: "col-sm-10 col-sm-offset-1"}, 
	            React.createElement("div", {className: "panel panel-default"}, 
	              React.createElement("div", {className: "panel-heading"}, "React Chatroom"), 
	                React.createElement(ChatList, {url: "https://api.parse.com/1/classes/chat?order=-createdAt"})
	              )
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddChat = React.createClass({displayName: "AddChat",
	...
	componentWillUnmount: function() {
	  ...
	  render: function(){
	  	...
	  	var list = this.state.chats.map (function(item, index) {
	  		return React.createElement("li", {className: "list-group-item", key: item.objectId}, 
	  				item.text, " ")
	  	});
